...
export function ElectricalFromToView() {
  ...
  return (
    <>
      ...
      >
        <CustomBreadcrumbs
          heading="Electrical Follow List"
          links={[
            ...
            {
              name: 'From To  Follow List',
            },
          ]}
          // action={
          //   <Button
          //     component={RouterLink}
          //     href={paths.dashboard.construction.ElectricalFromToView}
          //     variant="contained"
          ...
          >
            <DataGrid
              ...
              sx={{
                ...
                minHeight: 500, // Minimum height to ensure display with few items

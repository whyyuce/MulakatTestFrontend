...
export const GMN_API = import.meta.env.REACT_APP_GEMINI_API_KEY;
...
export const PATH_AFTER_LOGIN = paths.dashboard.construction.pipeFollow.spoolFollow; // as '/dashboard/construction/pipe-follow/spool-follow'

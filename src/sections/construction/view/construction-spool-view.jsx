...
import {
  ...
  RenderSpoolSystemNo,
  RenderSpoolAssembly,
  RenderSpoolSystemName,
  RenderSpoolTotalSpool,
  RenderSpoolProduction,
  RenderSpoolIsometricNo,
  RenderSpoolTestDelivery,
  RenderSpoolInstallationCompany,
  RenderSpoolManufacturingCompany,
} from '../construction-table-row';
...
export function SpoolView() {
  ...
  const columns = [
    ...
    },
    {
      ...
      minWidth: 160,
      editable: false,
      renderCell: (params) => <RenderSpoolSystemNo params={params} />,
    },
    {
      field: 'systemname',
      ...
      minWidth: 200,
      editable: false,
      renderCell: (params) => <RenderSpoolSystemName params={params} />,
    },
    {
      field: 'isometrino',
      headerName: 'Isometric No',
      minWidth: 190,
      editable: false,
      renderCell: (params) => <RenderSpoolIsometricNo params={params} />,
    },
    {
      field: 'spoolno',
      headerName: 'Spool No',
      ...
      editable: false,
      renderCell: (params) => <RenderSpoolNo params={params} />,
    },
    {
      field: 'rev',
      headerName: 'Rev',
      ...
      renderCell: (params) => <RenderSpoolRev params={params} />,
    },

    {
      ...
      editable: false,
      renderCell: (params) => <RenderSpoolWeight params={params} />,
    },
    {
      field: 'surface',
      headerName: 'Material',
      minWidth: 140,
      editable: false,
      renderCell: (params) => <RenderSpoolSurface params={params} />,
    },
    {
      field: 'date',
      headerName: 'Date',
      ...
      editable: false,
      renderCell: (params) => <RenderSpoolDate params={params} />,
    },
    {
      field: 'totalspool',
      headerName: 'Total Spool',
      ...
      maxWidth: 100,
      editable: false,
      renderCell: (params) => <RenderSpoolTotalSpool params={params} />,
    },
    {
      field: 'production',
      ...
      maxWidth: 100,
      editable: true,
      renderCell: (params) => <RenderSpoolProduction params={params} />,
    },
    {
      field: 'assembly',
      headerName: 'Installation',
      //  headerClassName: 'super-app-theme--header4',
      cellClassName: 'super-app-theme--header4',
      flex: 1,
      minWidth: 100,
      maxWidth: 100,
      editable: true,
      renderCell: (params) => <RenderSpoolAssembly params={params} />,
    },
    {
      field: 'test_delivery',
      headerName: 'Test',
      // headerClassName: 'super-app-theme--header6',
      cellClassName: 'super-app-theme--header6',

      flex: 1,
      minWidth: 100,
      maxWidth: 100,
      editable: true,
      renderCell: (params) => <RenderSpoolTestDelivery params={params} />,
    },
    {
      field: 'installation_company',
      headerName: 'Installation Company',
      ...
      maxWidth: 140,
      editable: true,
      renderCell: (params) => <RenderSpoolInstallationCompany params={params} />,
    },
    {
      field: 'manufanctuning_company',
      ...
      maxWidth: 140,
      editable: true,
      renderCell: (params) => <RenderSpoolManufacturingCompany params={params} />,
    },
  ];
  ...
  const CustomToolbar = () => (
    <GridToolbarContainer>
      ...
      {/* //TODO: buton dizayn değiştirilecektir */}
      <GridToolbarExportContainer>
  ...
  return (
    <>
      ...
      >
        <CustomBreadcrumbs
          heading="Spool Follow List"
          links={[
            { name: 'Construction Module', href: paths.dashboard.root },
            {
              name: 'Piping System Submodule',
            },
            {
              name: 'Spool Follow List',
            },
          ]}
          // action={
          //   <Button
          //     component={RouterLink}
          //     href={paths.dashboard.construction.SpoolView}
          //     variant="contained"
        ...
        >
          ...
          >
            <DataGrid
              ...
              sx={{
                boxShadow: 2,
                height: 600, // Set fixed height instead of percentage
                minHeight: 500, // Ensure minimum height even with few rows

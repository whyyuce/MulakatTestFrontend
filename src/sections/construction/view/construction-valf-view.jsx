...
import { getValves } from '../../../api/httpServices';
...
import {
  ...
  RenderActuatorDelivery,
  RenderValveInstallation,
  RenderActuatorInstallation,
...
export function ValfView() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('fetchedValves', fetchedValves);
        setRows([...fetchedValves.data, createEmptyRow()]);
        setSpools(fetchedValves.data);

        // Apply filters
        const filteredData = applyFilter({
          inputData: fetchedValves.data,
          filters,
        });
  ...
  const columns = [
    {
      ...
      editable: false,
      renderCell: (params) => <RenderDwg params={params} />,
    },
    {
      field: 'systemname',
    ...
    },
    {
      ...
      headerName: 'Valve No.',
      editable: false,
      renderCell: (params) => <RenderValveNo params={params} />,
    },
    {
      field: 'item',
      headerName: 'Item',
      editable: false,
      renderCell: (params) => <RenderItem params={params} />,
    },
    {
      field: 'dn',
      headerName: 'DN',
      editable: false,
      renderCell: (params) => <RenderDN params={params} />,
    },
    {
      field: 'pn',
      headerName: 'PN',
      editable: false,
      renderCell: (params) => <RenderPN params={params} />,
    },
    {
      field: 'type',
      headerName: 'Type',
      editable: false,
      renderCell: (params) => <RenderType params={params} />,
    },
    {
      field: 'conn',
      headerName: 'Connection',
      editable: false,
      renderCell: (params) => <RenderConn params={params} />,
    },
    {
      field: 'total',
      headerName: 'Total',
      editable: false,
      renderCell: (params) => <RenderTotal params={params} />,
    },
    {
      field: 'delivery',
      headerName: 'Delivery',
      editable: false,
      renderCell: (params) => <RenderDelivery params={params} />,
    },
    {
      field: 'actuatorDelivery',
      headerName: 'Actuator Delivery',
      editable: false,
      renderCell: (params) => <RenderActuatorDelivery params={params} />,
    },
    {
      field: 'valveInstallation',
      headerName: 'Valve Installation',
      editable: false,
      renderCell: (params) => <RenderValveInstallation params={params} />,
    },
    {
      field: 'actuatorInstallation',
      headerName: 'Actuator Installation',
      editable: false,
      renderCell: (params) => <RenderActuatorInstallation params={params} />,
    },
    // {
    //   field: 'companyName',
    //   headerName: 'Company Name',
    //   editable: false,
    //   renderCell: (params) => <RenderCompanyName params={params} />,
    // },
    {
      field: 'notes',
      headerName: 'Notes',
      editable: false,
      renderCell: (params) => <RenderNotes params={params} />,
    },
  ];
  ...
  return (
    <>
      ...
      >
        <CustomBreadcrumbs
          heading="Remote Valve Follow List"
          links={[
            ...
            {
              name: 'Valve Follow List',
            },
          ]}
          // action={
          //   <Button
          //     component={RouterLink}
          //     href={paths.dashboard.construction.ValfView}
          //     variant="contained"

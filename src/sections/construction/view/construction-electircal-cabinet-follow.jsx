...
export function ElectricalCabinetView() {
  ...
  const columns = [
    ...
    {
      field: 'systemname',
      headerName: 'Cabinets Installation',
      minWidth: 200,
      editable: false,
      renderCell: (params) => <RenderSpoolZone params={params} />,
    },
    ...
    {
      field: 'surface',
      headerName: 'Cable Supporting and Clip Checks',
      minWidth: 140,
      editable: false,
      renderCell: (params) => <RenderSpoolZone params={params} />,
    },
    {
      field: 'date',
      headerName: 'Wiring and Connection Inspections',
      width: 140,
      minWidth: 140,
      maxWidth: 140,
      flex: 1,
    ...
    {
      field: 'totalspool',
      headerName: 'Labeling and Identification Checks',
    ...
    {
      field: 'production',
      headerName: 'Owner Signature and Confirmation',
